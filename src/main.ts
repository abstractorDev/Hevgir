...
async function bootstrap() {
	...
	try {
		...
		// ۱. تنظیم متن پروفایل (Bio) - دریافت مستقیم متن به عنوان پارامتر
		await bot.api.setMyShortDescription(
			'هەڤگر (Hevgir): تحلیل‌گر و منتقد فکری؛ مجهز به Hybrid AI برای تقطیر و نقد بی‌طرفانهٔ مکالمات گروه.',
		);

		// ۲. تنظیم صفحه خوش‌آمدگویی (پاپ‌آپ اولیه) - دریافت مستقیم متن
		await bot.api.setMyDescription(
			`سلام! من Hevgir (هەڤگر) هستم.

یک تحلیل‌گر و منتقد فکری که برای گروه‌های عمیق طراحی شده‌ام. من مکالمات شما (فلسفه، سیاست، هنر و مسائل وجودی) را بدون سوگیری می‌خوانم، نویزها را حذف می‌کنم و در پایان روز، استدلال‌های شما را نقد کرده و منابع معتبر پیشنهاد می‌دهم.

ویژگی‌های من:
- تفکیک خودکار مباحث و حذف شوخی‌های روزمره
- نقد استدلال‌ها و شناسایی مغالطات فکری
- مدیریت کامل دسترسی و حفظ حریم خصوصی`,
		);
